...
- 普通继承，派生类继承了所有基类的函数与成员，要按照[字节对齐](https://www.jianshu.com/p/c42599622c31)（<font color='red'>以读取速度来换取空间的方式</font>）来计算大小
- 虚函数继承，不管是单继承还是多继承，都是<font color='red'>继承了基类的vptr。(32位操作系统4字节，64位操作系统 8字节)！</font>
- 虚继承,继承基类的vptr(4字节或者8字节)。
